 ...
 * on 2016-08-01 at 02:31:48 UTC 
 * Modify at your own risk.
 */

package com.example.q_lei.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokesapp-1469980547799.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.q_lei.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.q_lei.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.q_lei.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.q_lei.myapplication.backend.myApi.model.MyBean.class);
